...
-(CPTPlot*)allocPlot
{
	return [[TiChartsScatterPlot alloc] init];
}
...
-(void)configurePlot
{
    ...
    plot.shadow = [TiChartsParsers parseShadow:@"shadow" inProperties:self def:nil];

	// Parse the labels
	[TiChartsParsers parseLabelStyle:[self valueForUndefinedKey:@"labels"] forPlot:plot def:nil];
}
