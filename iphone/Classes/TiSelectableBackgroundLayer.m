...
{
  if ((_needsUpdate || _bufferImage == nil) && (gradient != nil || (color != nil && layer.shadowPath) || image != nil || _innerShadows != nil || svg != nil)) {
    _needsUpdate = NO;
...
{
  if (!force && !layer.shadowPath && _bufferImage && (color || image) && gradient == nil && _innerShadows == nil)
    return;
  RELEASE_TO_NIL(_bufferImage);
