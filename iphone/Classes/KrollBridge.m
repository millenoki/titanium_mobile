...
- (void)evalFileOnThread:(NSString *)path context:(KrollContext *)context_
{
  ...
  if ([path isEqualToString: [[host startURL] absoluteString]]) {
    jcode = [NSString stringWithFormat:@"var global = this;var exports ={};var module={exports:exports};%@", jcode];
  }
...
- (NSArray *)fullPathAndModuleID:(NSString *)path
{
  ...
  if (isAbsolute) {
    ...
    fullPath = (workingPath != nil) ? [[workingPath stringByAppendingPathComponent:[fullPath stringByStandardizingPath]] stringByStandardizingPath] : [fullPath stringByStandardizingPath];
    moduleID = [[fullPath pathComponents] objectAtIndex:0];
  }
...
- (KrollWrapper *)loadJavascriptText:(NSString *)data fromFile:(NSString *)filename withContext:(KrollContext *)kroll checkModule:(BOOL)checkModule
{
