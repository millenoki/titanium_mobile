...
@implementation TiUICollectionItemProxy {
...
//            }
//
//            if (![viewProxy isKindOfClass:[TiUICollectionItemProxy class]]) {
...
{
  return [_listViewProxy shouldHighlightCurrentCollectionItem];
}
