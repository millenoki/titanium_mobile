...
- (CGImageRef)newSweepImageGradientInRect:(CGRect)rect
{
    ...
    int colorCount = (int)CFArrayGetCount(colorValues);
    int locationCount = 0;
    int* colors = NULL;
    ...
    CGBitmapInfo bitmapInfo = (CGBitmapInfo)(kCGImageAlphaPremultipliedLast | kCGBitmapByteOrder32Little);
...
static inline int lerp(int a, int b, CGFloat w)
{
...
void angleGradient(byte* data, int w, int h, int* colors, int colorCount, CGFloat* locations, int locationCount, CGPoint center, float startAngle)
{
