...
- (void)deviceRotationBegan:(NSNotification *)notification
{
  ...
  if (nextOrientation == UIDeviceOrientationFaceUp || nextOrientation == UIDeviceOrientationFaceDown || nextOrientation == UIDeviceOrientationUnknown)
    return;
