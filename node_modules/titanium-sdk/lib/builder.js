...
Builder.prototype.validateTiModules = function validateTiModules(platformName, deployType, callback) {
	...
	appc.timodule.find(this.cli.tiapp.modules, platformName, deployType, this.titaniumSdkVersion, moduleSearchPaths, this.config, this.logger, function (modules) {
