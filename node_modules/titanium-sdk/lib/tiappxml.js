								...
								xml.forEachElement(elem, function (elem) {
									if (elem.tagName === 'dict') {
										...
										Object.keys(pl).forEach(function (prop) {
											if (!/^CFBundle(DisplayName|Executable|IconFile|Identifier|InfoDictionaryVersion|Name|PackageType|Signature|ShortVersionString)|LSRequiresIPhoneOS$/.test(prop)) {
