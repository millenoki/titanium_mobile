			...
			switch (cli.argv.target) {
				case 'simulator':
					if (cli.argv['build-only']) {
						cmd.push('build', cli.argv['ios-version'], cli.argv['project-dir'], tiapp.id, tiapp.name, cli.argv['device-family'], cli.argv['sim-type']);
					} else {
						cmd.push('run', cli.argv['project-dir'], cli.argv['ios-version'], '', '', cli.argv['device-family'], cli.argv['sim-type']);
					}
					break;
				
				case 'device':
					cmd.push('install', cli.argv['ios-version'], cli.argv['project-dir'], tiapp.id, tiapp.name, cli.argv['pp-uuid'], cli.argv['developer-name'], cli.argv['device-family'], cli.argv.keychain);
					break;
				...
				case 'dist-adhoc':
					cmd.push('adhoc', cli.argv['ios-version'], cli.argv['project-dir'], tiapp.id, tiapp.name, cli.argv['pp-uuid'], cli.argv['distribution-name'], cli.argv['device-family'], cli.argv.keychain);
					break;
			}

			if (cli.argv['deploy-type'])
				cmd.push(cli.argv['deploy-type']);
