...
public class TiCollectionViewTemplate {
	...
	//Identifier for template, specified in CollectionView creation dict
	...
	public TiCollectionViewTemplate(String id, KrollDict properties) {
	...
	public CollectionItemProxy generateCellProxy(KrollDict data, KrollProxy proxy)
	{
	    CollectionItemProxy result = (CollectionItemProxy) proxy.createTypeViewFromDict(properties, "Ti.UI.ListItem");
		return result;
	}
