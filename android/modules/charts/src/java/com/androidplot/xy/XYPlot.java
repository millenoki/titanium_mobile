...
public class XYPlot extends Plot<XYSeries, XYSeriesFormatter, XYSeriesRenderer> {
    ...
    public String getDomainLabel() {
        return getGraphWidget().getDomainOriginLabel();
    }

    public void setDomainLabel(String domainLabel) {
        getGraphWidget().setDomainOriginLabel(domainLabel);
    }

    public String getRangeLabel() {
        return getGraphWidget().getRangeOriginLabel();
    }

    public void setRangeLabel(String rangeLabel) {
    	getGraphWidget().setRangeOriginLabel(rangeLabel);
    }
