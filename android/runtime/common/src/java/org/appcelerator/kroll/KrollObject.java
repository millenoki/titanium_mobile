...
public abstract class KrollObject implements Handler.Callback
{
	...
	protected abstract boolean fireEvent(Object source, String type, Object data, boolean bubbles, boolean reportSuccess, int code, String message);
	protected abstract void doRelease();
	protected abstract void doSetWindow(Object windowProxyObject);
	protected abstract void updateNativeProperties(HashMap<String, Object> properties);
}
